  ...
  return (
    <main className=" min-h-svh bg-offwhitebg py-20 px-6 antialiased lg:flex justify-center items-center">
      <section className="lg:flex  max-w[920px]">
        ...
        <div className="bg-darkgreen p-12 max-lg:rounded-b-lg lg:rounded-r-lg">
          ...
          <a className="font-lexend bg-offwhitebg block px-10 py-3 w-fit rounded-3xl text-darkgreen border-2 border-offwhitebg hover:bg-darkgreen hover:text-offwhitebg" href="https://www.webmotors.com.br/carros-de-luxo" target="_blank">Ver mais</a>
        </div>
      </section>
    </main>
  )
