    ...
    <main className=" min-h-svh bg-offwhitebg py-20 px-6 antialiased lg:flex justify-center items-center">
      <section className="lg:flex">
        <div className="bg-orange p-12 rounded-t-lg">
          <img src={iconSedans} alt="icone dos sedans" className="mb-7" />
        ...
        <div className="bg-green p-12">
          ...
          <a className="font-lexend bg-offwhitebg block px-10 py-3 w-fit rounded-3xl text-green"href="https://www.webmotors.com.br/suvs/carros/estoque?tipoveiculo=carros&necessidade=SUVs" target="_blank">Ver mais</a>
        </div>

        <div className="bg-darkgreen p-12 rounded-b-lg">
          <img src={iconLuxury} alt="icone dos luxuosos" className="mb-7" />
          ...
          <a className="font-lexend bg-offwhitebg block px-10 py-3 w-fit rounded-3xl text-darkgreen" href="https://www.webmotors.com.br/carros-de-luxo" target="_blank">Ver mais</a>
        </div>
      </section>
    </main>
  )
